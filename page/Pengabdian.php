...
<html>
	...
	<body style="background-color: #000033;">
        ...
        <div class="container-fluid bg-3 text-left"> 
            <h3 style="border-style: solid;padding-bottom: 10px;padding-top:20px;border-top-color:transparent;border-right-color: transparent;border-left-color: transparent;border-bottom-color: #ffcc00; width:150px;">Pengabdian</h3>
            <div class="row" style="border-style: solid;padding-bottom: 10px;padding-top:20px; border-color:transparent;">
                <div class="col-sm-4"> 
                    <img src="3.jpg" class="img-responsive margin" style="width:100%" alt="Image">
