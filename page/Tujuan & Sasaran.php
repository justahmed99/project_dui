	...
	<body style="background-color: #000033;">
		...
		<div class="container-fluid" style="border-style: solid; background-color:white; padding-top: 20px;border-top-color: #ffcc00;border-right-color: transparent;border-left-color: transparent;border-bottom-color: #ffcc00">
			<div class="row justify-content-md-center" style="padding-bottom:20px;">
				<div class="col">
                    <h3 class="text-center" style="color:cornflowerblue">Tujuan </h3>
					<ul class="list-group">
...
Vivamus a tellus. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin pharetra nonummy pede. Mauris et orci. Aenean nec lorem.In porttitor. Donec laoreet nonummy augue. Suspendisse dui purus, scelerisque at, vulputate vitae, pretium mattis, nunc. Mauris eget neque at sem venenatis eleifend.
				...
				<div class="col">
                    <h3 class="text-center" style="color:cornflowerblue">Sasaran</h3>
					<ul class="list-group">
                        <li class="list-group-item">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna. Nunc viverra imperdiet enim. Fusce est.
