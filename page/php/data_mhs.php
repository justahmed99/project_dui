...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="custom/table_mhs_reg.css">
		<link rel="stylesheet" href="custom/table_mhs_nreg.css">
		<link rel="stylesheet" href="custom/table_jml_mhs_reg.css">
        <style>
            br {
                margin: 2em;
                font-size: 24%;
	...
	<body style="background-color: #000033;">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<div class="dropdown">
							...
							<div class="dropdown-content">
							  ...
							  <a href="layanan_mhs.php">Layanan Mahasiswa</a>
		...
		<div class="container-fluid" style="padding-top: 20px;padding-bottom: 20px;">
            <h3 class="text-center" style="color:white">Data Mahasiswa</h3>
        </div>
		...
		<div class="container" style="background-color: white; border-style: solid;padding-top: 20px;border-top-color: white;border-right-color: transparent;border-left-color: transparent;border-bottom-color: transparent;">
			<div class="row justify-content-md-center" style="padding-bottom:20px;">
				<div class="col">
                    <h3 class="text-center" style="color:cornflowerblue">Mahasiswa Reguler</h3>
					<?php include 'tabel_mhs_reg.php';?>
					<br>
					<h3 class="text-center" style="color:cornflowerblue">Mahasiswa Non-Reguler</h3>
					<?php include 'tabel_mhs_nreg.php';?>
					<br>
					<h3 class="text-center" style="color:cornflowerblue">Jumlah Mahasiswa Reguler 7 tahun terakhir</h3>
					<?php include 'tabel_jml_mhs_reg.php';?>
				</div>
			</div>
        </div>
